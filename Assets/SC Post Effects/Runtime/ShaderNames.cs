namespace SCPE
{
    internal static class ShaderNames
    {
        ...
        public const string CopyDepth = "Hidden/Universal Render Pipeline/CopyDepth";
        public const string BlendDepth = "Hidden/SC Post Effects/DepthBlend";
    }

    internal static class ShaderKeywords
    {
        public const string StackedCamera = "STACKED_CAMERA";
    }
    ...
    internal static class TextureNames
    {
        ...
        public const string DepthCopy = "_DepthCopy";
        public const string BlendedDepth = "_BlendedDepth";
    }
}