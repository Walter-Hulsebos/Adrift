...
namespace SCPE
{
    ...
    public sealed class Sunshafts : VolumeComponent, IPostProcessComponent
    {
        ...
        [Serializable]
        public sealed class SunShaftsSourceParameter : VolumeParameter<SunshaftsBase.BlendMode> { }
        [Tooltip("Additive mode adds the sunshaft color to the image, while Screen mode perserves color values")]
        public SunShaftsSourceParameter blendMode = new SunShaftsSourceParameter { value = SunshaftsBase.BlendMode.Additive };

        [Serializable]
        public sealed class SunShaftsResolutionParameter : VolumeParameter<SunshaftsBase.SunShaftsResolution> { }
        ...
        public FloatParameter falloff = new FloatParameter(0.5f, false);

        [Tooltip("The length of the sunrays from the caster's position to the camera")]
        [Min(0f)]
        public FloatParameter length = new FloatParameter(10f, false);
