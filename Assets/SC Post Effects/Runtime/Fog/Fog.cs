...
namespace SCPE
{
    ...
    public sealed class Fog : VolumeComponent, IPostProcessComponent
    {
...
#endif
        public ColorParameter fogColor = new ColorParameter(new Color(0.76f, 0.94f, 1f, 1f));
        ...
        //Between Unity 2018.1 and ??? this is necessary. URP does not render depth normals, HDRP requires it too
